  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">SharkShopAdmin</span>
      </a>
     ...
     @if (Auth::user()->function == 1)
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-menu-button-wide"></i><span>Chức Năng</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
     ...
     @endif
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="{{URL::to('/binh-luan')}}">
              <i class="bi bi-circle"></i><span>Bình luận</span>
            </a>
          </li>
          <li>
            <a href="{{URL::to('/nhat-ky')}}">
              <i class="bi bi-circle"></i><span>Nhật Ký</span>
            </a>
          </li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-layout-text-window-reverse"></i><span>Chat</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
